...
describe('resource assets', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = client.v1.assets.list();
  ...
  test.skip('getPriceHistory: only required params', async () => {
    const responsePromise = client.v1.assets.getPriceHistory({
      end: 0,
      period: 'h',
      start: 0,
    });
  ...
  test.skip('getPriceHistory: required and optional params', async () => {
    const response = await client.v1.assets.getPriceHistory({
      end: 0,
      period: 'h',
      start: 0,
  ...
  test.skip('listPrices', async () => {
    const responsePromise = client.v1.assets.listPrices();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listPrices: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.assets.listPrices({ with_text: true }, { path: '/_stainless_unknown_path' }),
