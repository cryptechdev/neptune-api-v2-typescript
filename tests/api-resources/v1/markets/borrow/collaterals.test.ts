...
describe('resource collaterals', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = client.v1.markets.borrow.collaterals.list();
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.markets.borrow.collaterals.list(
  ...
  test.skip('lookupByAsset: only required params', async () => {
    const responsePromise = client.v1.markets.borrow.collaterals.lookupByAsset({
      asset_id: 'token;-K-//-//3-',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('lookupByAsset: required and optional params', async () => {
    const response = await client.v1.markets.borrow.collaterals.lookupByAsset({
      asset_id: 'token;-K-//-//3-',
      with_text: true,
      with_value: true,
    });
