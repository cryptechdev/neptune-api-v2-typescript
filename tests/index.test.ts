...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('default logLevel is warn', async () => {
      const client = new NeptuneAPIV2({ apiKey: 'My API Key' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      const client = new NeptuneAPIV2({ logger: logger, apiKey: 'My API Key' });
  ...
  describe('baseUrl', () => {
    ...
    test('no trailing slash', () => {
      const client = new NeptuneAPIV2({ baseURL: 'http://localhost:5000/custom/path', apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null)).toEqual('http://localhost:5000/custom/path/foo');
    });
    ...
    test('explicit option', () => {
      const client = new NeptuneAPIV2({ baseURL: 'https://example.com', apiKey: 'My API Key' });
    ...
    test('in request options overridden by client options', () => {
      const client = new NeptuneAPIV2({ apiKey: 'My API Key', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('maxRetries option is correctly set', () => {
    const client = new NeptuneAPIV2({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new NeptuneAPIV2({ apiKey: 'My API Key' });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['NEPTUNE_API_V2_API_KEY'] = 'My API Key';
    const client = new NeptuneAPIV2();
  ...
  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['NEPTUNE_API_V2_API_KEY'] = 'another My API Key';
    const client = new NeptuneAPIV2({ apiKey: 'My API Key' });
    expect(client.apiKey).toBe('My API Key');
  });
});
...
describe('retries', () => {
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new NeptuneAPIV2({ apiKey: 'My API Key', fetch: testFetch });
