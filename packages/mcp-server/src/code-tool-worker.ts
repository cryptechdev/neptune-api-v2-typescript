...
import { NeptuneAPIV2, ClientOptions } from '@neptunefinance/api-v2';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: NeptuneAPIV2)`
    : `const run: (${functionSource.client}: NeptuneAPIV2) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.assets.getPriceHistory',
    'client.assets.list',
    'client.assets.listPrices',
    'client.markets.getMerged',
    'client.markets.getMergedByAsset',
    'client.markets.getOverview',
    'client.markets.getParams',
    'client.markets.lend.getByAsset',
    'client.markets.lend.getRateHistory',
    'client.markets.lend.list',
    'client.markets.borrow.getOverview',
    'client.markets.borrow.getRateHistory',
    'client.markets.borrow.collaterals.getByAsset',
    'client.markets.borrow.collaterals.list',
    'client.markets.borrow.debts.getByAsset',
    'client.markets.borrow.debts.list',
    'client.nept.getParams',
    'client.nept.getStakingOverview',
    'client.nept.getState',
    'client.user.getTxHistory',
    'client.user.getUser',
    'client.user.market.getMerged',
    'client.user.market.getMergedByAsset',
    'client.user.market.getPortfolio',
    'client.user.market.lend.getByAsset',
    'client.user.market.lend.list',
    'client.user.market.borrow.getCollateralAccountsByAsset',
    'client.user.market.borrow.getCollateralTotals',
    'client.user.market.borrow.getDebtAccountsByAsset',
    'client.user.market.borrow.getDebtsTotals',
    'client.user.market.borrow.getPortfolio',
    'client.user.market.borrow.subaccount.getSubaccount',
    'client.user.market.borrow.subaccount.getSubaccountCollaterals',
    'client.user.market.borrow.subaccount.getSubaccountDebts',
    'client.user.market.borrow.subaccount.getSubaccountHealth',
    ...
    'client.user.wallet.getBalanceByAsset',
    'client.user.wallet.getBalances',
    'client.analytics.market.getCurrentState',
    'client.analytics.market.history.getLoansOriginated',
    'client.analytics.market.history.getLoansOriginatedByAsset',
    'client.integrations.bantr.getTransactions',
  ],
