...
export class LoansOriginated extends APIResource {
   ...
   */
  retrieveByAsset(
    query: LoansOriginatedRetrieveByAssetParams,
    options?: RequestOptions,
  ): APIPromise<LoansOriginatedRetrieveByAssetResponse> {
   ...
   */
  retrieveLoansOriginated(
    query: LoansOriginatedRetrieveLoansOriginatedParams,
    options?: RequestOptions,
  ): APIPromise<LoansOriginatedRetrieveLoansOriginatedResponse> {
    return this._client.get('/api/v1/analytics/market/history/loans-originated', { query, ...options });
  }
}

export interface LoansOriginatedRetrieveByAssetResponse {
  /**
   * Request status
   */
  status: number;
   ...
   */
  data?: LoansOriginatedRetrieveByAssetResponse.Data | null;
...
export namespace LoansOriginatedRetrieveByAssetResponse {
  /**
   * `AssetCumulativeValueHistory`
   *
   * ---
...
export interface LoansOriginatedRetrieveLoansOriginatedResponse {
  /**
   * Request status
   */
  status: number;
   ...
   * Historical cumulative lend value for assets
   */
  data?: LoansOriginatedRetrieveLoansOriginatedResponse.Data | null;
...
export namespace LoansOriginatedRetrieveLoansOriginatedResponse {
  /**
   * `CumulativeValueHistory`
   *
   * ---
...
export interface LoansOriginatedRetrieveByAssetParams {
  /**
...
export interface LoansOriginatedRetrieveLoansOriginatedParams {
  /**
   * End timestamp for interval range (inclusive)
   *
   * Must be provided as unix timestamp (in seconds)
